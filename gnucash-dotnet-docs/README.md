...
This directory replaces the standard Heurex `doc/` directory for this repository.
...
- [capabilities/non-ui-capability-atlas.md](capabilities/non-ui-capability-atlas.md)
- [capabilities/capability-coverage.json](capabilities/capability-coverage.json)
...
- [milestones/m11-full-accounting-workflows.md](milestones/m11-full-accounting-workflows.md)
